...
exports.getCacheKeyDebug = getCacheKeyDebug;
 ...
 */
function getCacheKey(farmId, deviceId, sensorType, value) {
    ...
    const hash = crypto_1.default.createHash('sha256').update(keyComponents).digest('hex');
 ...
 */
function getCacheKeyDebug(farmId, deviceId, sensorType, value) {
