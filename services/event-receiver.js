...
exports.eventReceiver = exports.EventReceiver = void 0;
...
class EventReceiver {
    ...
    `;
        ...
        const persistedEvent = await (0, database_1.insertOne)(query, params);
 ...
 */
exports.eventReceiver = new EventReceiver();
